...
const formImageUrl =
  "https://images.unsplash.com/photo-1481026469463-66327c86e544?q=80&w=2708&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
          ...
          if (password.length >= 6) {
            ...
            try {
              const response = await axios.post(
                `${process.env.REACT_APP_BACKEND_URL}/api/admins/signup`,
                signupData
              );
    ...
    <div className="flex h-screen w-full items-center justify-center bg-gray-100">
      <div className="w-full max-w-3xl overflow-hidden rounded-lg bg-white shadow-lg sm:flex">
        <div
          ...
          style={{ backgroundImage: `url(${formImageUrl})` }}
        ></div>
        <div className="w-full sm:w-3/5">
          <div className="p-8">
            ...
            <p className="mt-2 mb-5 text-base leading-tight text-gray-600">
              ...
              <span className="font-bold">iProp91</span>
            </p>
            <form className="mt-8">
