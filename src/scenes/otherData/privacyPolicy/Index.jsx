...
import PrivacyPolicyForm from "../../../components/frontendPreview/PrivacyPolicyForm";
...
function PrivacyPolicyIndex() {
  ...
  const fetchPrivacyPolicy = async (id) => {
    await axios
      .get(
        `${process.env.REACT_APP_BACKEND_URL}/api/privacyPolicy/fetch/${id}?userId=${userId}`,
        {
          headers: {
  ...
  const fetchAllPrivacyPolicies = (userId, userToken) => {
    axios
      .get(
        `${process.env.REACT_APP_BACKEND_URL}/api/privacyPolicy/fetchall?userId=${userId}`,
        {
          headers: {
            "auth-token": userToken,
          },
  ...
  const deletePrivacyPolicyById = async (id) => {
    await axios
      .delete(
        `${process.env.REACT_APP_BACKEND_URL}/api/privacyPolicy/delete/${id}?userId=${userId}`,
        {
          headers: {
            "auth-token": userToken,
          },
