...
import TermsAndConditionsForm from "../../../components/frontendPreview/TermsAndConditionsForm";
...
function Index() {
  ...
  const fetchPrivacyPolicy = async (id) => {
    await axios
      .get(
        `${process.env.REACT_APP_BACKEND_URL}/api/termsAndConditions/fetch/${id}?userId=${userId}`,
        {
          headers: {
  ...
  const fetchAllPrivacyPolicies = (userId, userToken) => {
    axios
      .get(
        `${process.env.REACT_APP_BACKEND_URL}/api/termsAndConditions/fetchAll?userId=${userId}`,
        {
          headers: {
            "auth-token": userToken,
          },
  ...
  const deletePrivacyPolicyById = async (id) => {
    await axios
      .delete(
        `${process.env.REACT_APP_BACKEND_URL}/api/termsAndConditions/delete/${id}?userId=${userId}`,
        {
          headers: {
            "auth-token": userToken,
          },
