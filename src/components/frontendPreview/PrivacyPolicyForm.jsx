...
function PrivacyPolicyForm({ editData, setModeToDisplay, userToken, userId }) {
  ...
  const handleSubmit = () => {
    if (addData.text !== "") {
      if (editData) {
        axios
          .put(
            `${process.env.REACT_APP_BACKEND_URL}/api/privacyPolicy/update/${editData._id}?userId=${userId}`,
            addData,
            {
              headers: {
        ...
        axios
          .post(
            `${process.env.REACT_APP_BACKEND_URL}/api/privacyPolicy/add?userId=${userId}`,
            addData,
            {
              headers: {
                "auth-token": userToken,
        ...
        <div className="w-full">
          <form>
            ...
            <div className="flex justify-center mt-5">
              ...
              >
                {editData ? "Update Privacy Policy" : "Add Privacy Policy"}
              </button>
            </div>
          </form>
