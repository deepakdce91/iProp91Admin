...
function MarkUnreadModal({ handleMarkUnread, closeModal }) {
  return (
    <div className="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
      <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-6 relative">
        ...
        <IoMdMailUnread className="w-14 h-14 fill-red-500 inline"/>
          
          <h4 className="text-gray-800 text-lg font-semibold mt-4">
            Mark this field unread?
          </h4>
        </div>
        ...
        <div className="flex flex-col space-y-2">
          <button
            ...
            type="button"
            className="px-4 py-2 rounded-lg text-white text-sm tracking-wide bg-gray-700 hover:bg-gray-900 active:bg-gray-700"
          >
            Mark unread
          </button>
          <button
...
export default MarkUnreadModal;
