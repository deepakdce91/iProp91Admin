...
import RewardsLedger from "./scenes/configurations/rewardsLedger/Index.jsx";
...
const routes = {
  ...
  home: "/",
  rewards : "/rewards",
  rewardsLedger : "/globalRewardsLedger",
  vouchers : "/vouchers",
            ...
            <Routes>
              ...
              {userId && userToken && (
                <>
                  ...
                  <Route path={routes.rewardsLedger} element={<RewardsLedger />} />
